...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "brou | agenda — Agendamiento automatizado por WhatsApp" },
      { property: "og:description", content: "Tu agente AI agenda, confirma y recuerda citas 24/7." },
